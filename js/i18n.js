...
const I18N_DATA = {
    ...
    "en_gb": {
        ...
        "download_ios": "Download iOS Version (Aisi Self-Signed)",
        "dark_mode": "Dark Mode",
    ...
    "ja": {
        ...
        "download_ios": "iOSバージョンをダウンロード（愛思自签）",
        "dark_mode": "ダークモード",
        "light_mode": "ライトモード",
        "categories": "カテゴリー",
    ...
    "ko": {
        ...
        "download_ios": "iOS 버전 다운로드 (Aisi 자체 서명)",
        "dark_mode": "다크 모드",
        "light_mode": "라이트 모드",
        "categories": "카테고리",
    ...
    "ru": {
        ...
        "download_ios": "Скачать версию для iOS (Aisi Self-Signed)",
